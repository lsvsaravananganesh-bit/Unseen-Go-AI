...
(function(){
  ...
  function loadEnhancements(){if(document.querySelector('script[data-unseengo-enhancements]'))return;const s=document.createElement('script');s.src='unseengo-enhancements.js?v=20260824';s.dataset.unseengoEnhancements='true';document.body.appendChild(s)}
