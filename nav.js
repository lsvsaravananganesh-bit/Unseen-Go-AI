...
(function(){
  // Clear stale service-worker caches left by older versions of the site.
  // The current static site should always load the latest theme/assets from GitHub Pages.
